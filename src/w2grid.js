...
(function ($) {
    ...
    w2grid.prototype = {
        ...
        buttons: {
            ...
            'search-go': { type: 'drop',  id: 'w2ui-search-advanced', icon: 'w2ui-icon-search', tooltip: 'Open Search Fields' },
        ...
        localSearch: function (silent) {
            ...
            function getDateField(rec, search) {
                ...
                date = w2utils.isDate(String(date), w2utils.settings.dateFormat, true);
            ...
            function searchRecord(rec) {
                ...
                for (var j = 0; j < obj.searchData.length; j++) {
                    ...
                    if (sdata.required || obj.last.logic == 'AND') {       /* required field */
                        andTot++;
                        andNb += fl;
                        if (!fl)
